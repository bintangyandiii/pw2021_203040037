...
<body>
    <div class="container">
        ...
        <h3>Silahkan Tambah Apapun Yang Anda Inginkan</h3>
        <form action="" method="post">
            ...
            <label for="Price">Masukan Harga yang di wajar</label>
            <input type="text" placeholder="IDR.000" data-role="input" name="Price" id="Price" require><br>
